...
class ParaStrut:
    ...
    def getPara():
        ...
        print('%s大家好，%s%s。%s是怎么回事呢?%s相信大家都很熟悉，但是%s是怎么回事呢?下面就让小编带大家一起了解吧。%s，其实就是%s，大家可能会感到很惊讶，但事实就是这样，小编也感到非常惊讶。那么这就是关于%s的事情了，大家有什么想法呢？欢迎在评论区告诉小编一起讨论哦。视频资料来自互联网，这里是%s，我们下期再见，拜拜。'\
